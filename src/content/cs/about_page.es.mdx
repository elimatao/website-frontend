...
## Funcionamiento
Para detalles sobre las tecnologías utilizadas para crear este sitio, por favor visita la página de <Link href="/cs/changelog" locale="en">Registro de cambios</Link>.
